                                ...
                                <div class="row">
                                    ...
                                    <!-- <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?= form_input('awb_no', '', 'class="form-control tip" id="awb_no" placeholder="Airway Bill" readonly'); ?>
                                        </div>
                                    </div> -->
                                    <!-- <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <!-- <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?= form_input('shipping_price', '', 'class="form-control tip" id="shipping_price" placeholder="Shipping Price" readonly'); ?>
                                        </div>
                                    </div> -->
                                    <!-- <div class="col-md-6">
                                        <div class="form-group">
